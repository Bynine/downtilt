...
public abstract class MoveList_Advanced extends MoveList{
	...
	public static final int IDuweak = 1;
	public static final int IDdweak = 2;
	public static final int IDnweak = 3;
	public static final int IDsweak = 4;
	public static final int IDslide = 5;
	public static final int IDuspecial = 10;
	public static final int IDdspecial = 11;
	public static final int IDnspecial = 12;
	public static final int IDuthrow = 20;
	public static final int IDdthrow = 21;
	public static final int IDfthrow = 22;
	public static final int IDbthrow = 23;
	public static final int IDuairthrow = 24;
	public static final int IDdairthrow = 25;
	public static final int IDfairthrow = 26;
	public static final int IDbairthrow = 27;
	public static final int IDucharge = 40;
	public static final int IDdcharge = 41;
	public static final int IDncharge = 42;
	public static final int IDuair = 50;
	public static final int IDdair = 51;
	public static final int IDfair = 52;
	public static final int IDbair = 53;
	public static final int IDnair = 54;
