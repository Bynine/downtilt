...
public abstract class Explosion extends ImmobileEntity{
	...
	protected static class GrenadeExplosion extends Explosion{
		...
		public GrenadeExplosion(Fighter owner, Hurlable grenade) {
			...
			ac =  new ExplosionHitbox(owner, 8, 5, 8, 71, 0, 0, 36, new SFX.HeavyHit(), this, lifeTime);
			Hitbox ac2 = new ExplosionHitbox(owner, 7, 4, 24, Hitbox.SAMURAI, 0, 0, 48, new SFX.HeavyHit(), this, lifeTime);
			ac.setRefresh(1);
